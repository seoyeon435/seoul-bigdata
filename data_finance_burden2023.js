...
const FINANCE = {
  ...
  /* 클러스터별 봉투가격 탄력성
     (가격 1% 인상 시 배출량 변화율; 음수 = 가격 오르면 배출 감소)
     근거: 선행연구(Kinnaman 2006, 한국 추정치) + 클러스터 특성 보정 */
  bagElasticity: {
    0: -0.60, /* 주거형: 가격 민감. 거주민이 비용 직접 부담 */
    1: -0.25, /* 상업형: 가격 둔감. 사업장 비중 높아 비용 전가 가능 */
    2: -0.40, /* 유동집중형: 중간. 거주+유동인구 혼재 */
    3: -0.35  /* 혼합형: 중간-하. 산업·주거 복합 구조 */
  },
